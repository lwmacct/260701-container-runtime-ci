...
_docker_in_docker_base_image="${MAIVO_CI_DOCKER_IN_DOCKER_BASE_IMAGE:-1181.s.kuaicdn.cn:11818/ghcr.io/lwmacct/250210-cr-docker:29.4.0-dind-260408}"
...
_container_security_policy_base_image="${MAIVO_CI_CONTAINER_SECURITY_POLICY_BASE_IMAGE:-1181.s.kuaicdn.cn:11818/docker.io/library/python:3.12-alpine}"
...
_kubernetes_k3s_base_image="${MAIVO_CI_KUBERNETES_K3S_BASE_IMAGE:-1181.s.kuaicdn.cn:11818/docker.io/rancher/k3s:v1.30.6-k3s1}"
_kubernetes_k3s_image="${MAIVO_CI_KUBERNETES_K3S_IMAGE:-$(__image_tag maivo-ci/kubernetes-k3s latest)}"
_kubernetes_k3s_pause_source_image="${MAIVO_CI_KUBERNETES_K3S_PAUSE_SOURCE_IMAGE:-1181.s.kuaicdn.cn:11818/docker.io/rancher/mirrored-pause:3.6}"
...
_systemd_pid1_base_image="${MAIVO_CI_SYSTEMD_PID1_BASE_IMAGE:-1181.s.kuaicdn.cn:11818/docker.io/library/ubuntu:24.04}"
...
_procfs_memory_base_image="${MAIVO_CI_PROCFS_MEMORY_BASE_IMAGE:-1181.s.kuaicdn.cn:11818/docker.io/library/python:3.12-alpine}"
...
_seccomp_notify_concurrency_base_image="${MAIVO_CI_SECCOMP_NOTIFY_CONCURRENCY_BASE_IMAGE:-1181.s.kuaicdn.cn:11818/docker.io/library/python:3.12-alpine}"
...
_inner_nginx_base_image="${MAIVO_CI_INNER_NGINX_BASE_IMAGE:-1181.s.kuaicdn.cn:11818/docker.io/nginx:latest}"
